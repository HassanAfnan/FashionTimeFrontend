...
import 'package:FashionTime/models/chats_model.dart';
...
class _CallJoinState extends State<CallJoin> {
  ...
  sendCall(String callerName,String from_user,String to_user)async{
    var callBody=jsonEncode(<String,dynamic>{
      "title":"${callerName} Called you",
      "from_user":int.parse(from_user),
      "to_user":int.parse(to_user)
    });
  ...
  getCall(String from_user,String to_user)async{
    var callBody=jsonEncode(<String,dynamic>{
      "title":"You called.",
      "from_user":int.parse(from_user),
      "to_user":int.parse(to_user)
