            ...
            children: [
              Expanded(
                child: TextField(
                  ...
                  cursorColor: primary,
                  style: TextStyle(
                      color: primary, fontSize: 13, fontFamily: 'Montserrat'),
                ),
              ),
              SizedBox(
        ...
        GridView.builder(
          ...
          itemBuilder: (context, index) {
            return   Padding(
              ...
              child: Center(child: Text(hashtagsList[index],style: TextStyle(color: primary,fontWeight: FontWeight.bold,fontFamily: "Montserrat"),)),
            );
          },
        ):const SizedBox(),
        Padding(
