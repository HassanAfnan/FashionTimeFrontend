        ...
        jsonDecode(value.body).forEach((data){
          setState(() {
            friends.add(ChatModel(
                ...
                data["fans"]["name"],
                data["fans"]["pic"] == null?"https://firebasestorage.googleapis.com/v0/b/fashiontime-28e3a.appspot.com/o/WhatsApp_Image_2023-11-08_at_4.48.19_PM-removebg-preview.png?alt=media&token=215bdc12-d53a-4772-bca1-efbbdf6ee955&_gl=1*nea8nk*_ga*NDIyMTUzOTQ2LjE2OTkyODU3MDg.*_ga_CW55HF8NVT*MTY5OTQ0NDE2NS4zMy4xLjE2OTk0NDUxNzcuNTYuMC4w":data["fans"]["pic"],
                data["fans"]["email"],
                data["fans"]["username"],
                data["fans"]["fcmToken"]
            ));
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Fans",style: TextStyle(fontFamily: 'Montserrat'),),
      ),
      body:loading == true ? SpinKitCircle(size: 50,color: primary,) : (friends.length<=0 ? Center(child: Text("No Fans")) :ListView.builder(
