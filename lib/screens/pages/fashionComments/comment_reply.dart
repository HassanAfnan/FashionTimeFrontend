        ...
        children:  [
          ...
          Expanded(
              ...
              replyComments.isEmpty?
                                    ...
                                    child: ListTile(
                                      ...
                                      subtitle: myReplyComments[index]['comment'].toString().startsWith('https://media')?Flexible(child: buildGifWidget(context, replyComments[index]['comment'].toString())):Row(
                                        children: [
                                          ...
                                          Flexible(child: Text(handleEmojis(myReplyComments[index]["comment"]+"(edited)"),style: const TextStyle(fontFamily: "Montserrat"),)):
                                          Flexible(child: Text(handleEmojis(myReplyComments[index]["comment"]),style: const TextStyle(fontFamily: "Montserrat"),))
                                          ,
                                        ],
                                      ),
                  ...
                  const Center(child: Text("No Comments.",style: TextStyle(fontFamily: "Montserrat",fontWeight: FontWeight.w400) ,)):
              (Expanded(
                child: AnimationLimiter(
                  child: ListView.builder(
                            ...
                            Padding(
                              ...
                              child: GestureDetector(
                                ...
                                child: ListTile(
                                  ...
                                  title: Text(replyComments[index]["user"]["username"],style: const TextStyle(fontFamily: "Montserrat",fontWeight: FontWeight.w400)),
                                  subtitle: Row(
                                    children: [
                                      Text(handleEmojis(widget.commentName),style:  TextStyle(fontFamily: "Montserrat",fontWeight: FontWeight.w900,color: primary),),
                                      ...
                                      Flexible(child: Text(handleEmojis(replyComments[index]["comment"]+"(edited)"),style: const TextStyle(fontFamily: "Montserrat"),)):
