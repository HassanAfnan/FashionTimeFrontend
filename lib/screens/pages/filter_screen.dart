    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData.isNotEmpty) {
          print("get all events data " + responseData.toString());
          setState(() {
            items =
      ...
      Center(
        child: ListView(
          children: [
            ...
            //       //     underline: SizedBox(),
            //       //     hint: Text("Fashion Type",style: TextStyle(fontFamily: 'Montserrat'),),
            //       //     value: dropdownvalue,
                    ...
                    if(_selectedDate==null&&selectedIndex==-1){
                      ...
                      showDialog(
                        ...
                        builder: (context) => AlertDialog(
                          ...
                          content: const Text("Please select all fields.",style: TextStyle(color: ascent,fontFamily: 'Montserrat'),),
                          actions: [
                            TextButton(
