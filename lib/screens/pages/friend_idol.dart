...
class FriendsIdols extends StatefulWidget {
  final String friendId;
  const FriendsIdols({super.key, required this.friendId});

  @override
  State<FriendsIdols> createState() => _FriendsIdolsState();
}
bool loading=false;
String token="";
String id="";
class _FriendsIdolsState extends State<FriendsIdols> {
  ...
  getMyFriends(){
    ...
    try{
      https.get(
          Uri.parse("$serverUrl/fansfriends/${widget.friendId}/idols/"),
          headers: {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Idols",style: TextStyle(fontFamily: 'Montserrat'),),
      ),
