  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text("Group Info",style: TextStyle(fontFamily: 'Montserrat'),),
      ),
      body: Column(
        children: [
                ...
                showDialog(
                  ...
                  builder: (BuildContext context) {
                    return AlertDialog(
                      ...
                      title: const Text('Edit group name',style: TextStyle(fontFamily: 'Montserrat'),),
                      content: TextField(
          ...
          widget.members.length <= 0 ? const Expanded(child: Center(child: Text("No Members"),)) : Expanded(
