  ...
  deleteReel(reelId)async {
    ...
    showDialog(context: context, builder: (context) {
      return  AlertDialog(
        ...
        content: const Text("Delete flick?",style: TextStyle(color: ascent,fontFamily: 'Montserrat')),title: const Text("FashionTime",style: TextStyle(color: ascent,fontFamily: 'Montserrat',fontWeight: FontWeight.bold)),actions: [
