        ...
        print(jsonDecode(value.body).toString());
          setState(() {
            post = PostModel(
                ...
                jsonDecode(value.body)["description"] == null ? "":jsonDecode(value.body)["description"],
                jsonDecode(value.body)["upload"]["media"],
                jsonDecode(value.body)["user"]["name"],
                jsonDecode(value.body)["user"]["pic"] == null ? "https://firebasestorage.googleapis.com/v0/b/fashiontime-28e3a.appspot.com/o/WhatsApp_Image_2023-11-08_at_4.48.19_PM-removebg-preview.png?alt=media&token=215bdc12-d53a-4772-bca1-efbbdf6ee955&_gl=1*nea8nk*_ga*NDIyMTUzOTQ2LjE2OTkyODU3MDg.*_ga_CW55HF8NVT*MTY5OTQ0NDE2NS4zMy4xLjE2OTk0NDUxNzcuNTYuMC4w":jsonDecode(value.body)["user"]["pic"],
                false,
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            SizedBox(width: 10,),
                            Text(post.userName,style: TextStyle(color: primary,fontSize: 15,fontWeight: FontWeight.bold,fontFamily: 'Montserrat'),)
                          ],
                        ),
                      ],
                    ),
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Row(
                              children: [
                                Text("${post.likeCount}",style: TextStyle(fontFamily: 'Montserrat'),),
                              ],
                            ),
                            SizedBox(width: 10,),
                            Row(
                ...
                children: [
                  ...
                  Container(
                    child: ConstrainedBox(
                      ...
                      child: AutoSizeText(
                        post.description,
                        style: TextStyle(fontSize: 10.0,fontFamily: 'Montserrat'),
                      ),
                    ),
                  ),
                ],
