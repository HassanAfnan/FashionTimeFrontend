...
import 'package:FashionTime/models/saved_post_model.dart';
...
class PostScrollToMedals extends StatefulWidget {
  final String title;
  late List<PostModel>? posts;
  final int index;
  PostScrollToMedals({super.key, required this.title,this.posts, required this.index});

  @override
  State<PostScrollToMedals> createState() => _PostScrollToMedalsState();
}

class _PostScrollToMedalsState extends State<PostScrollToMedals> {
  String id = "";
  String name = "";
  String token = "";
                                      ...
                                      showModalBottomSheet(
                                          ...
                                          builder: (ctx) {
                                            return Container(
                                              ...
                                              child: CommentScreen(
                                                  id: widget.posts![index]
                                                      .id,
                                                  pic: widget.posts![index]
                                                      .userPic),
                                            );
                                          });
                                      // Navigator.push(
                                    ...
                                    children: [
                                      isExpanded
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${handleEmojis(widget.posts![index].description.substring(0, 7))}...",
                                            style:
                                            const TextStyle(
                                              fontFamily:
                                              'Montserrat',
