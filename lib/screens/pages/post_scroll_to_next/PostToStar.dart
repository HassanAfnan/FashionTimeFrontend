...
class PostScrollToStar extends StatefulWidget {
  final String title;
  late List<PostModel>? posts;
  final int index;
  PostScrollToStar({super.key, required this.title,this.posts, required this.index});

  @override
  State<PostScrollToStar> createState() => _PostScrollToStarState();
}

class _PostScrollToStarState extends State<PostScrollToStar> {
  String id = "";
  String name = "";
  String token = "";
                                    ...
                                    children: [
                                      isExpanded
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "${handleEmojis(widget.posts![index].description)}...",
                                            style:
                                            const TextStyle(
                                              fontFamily:
                                              'Montserrat',
