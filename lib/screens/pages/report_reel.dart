...
class ReelReportScreen extends StatefulWidget {
  final int reelId;
  final int userId;
  const ReelReportScreen(
      {super.key, required this.reelId, required this.userId});

  @override
  State<ReelReportScreen> createState() => _ReelReportScreenState();
}
...
class _ReelReportScreenState extends State<ReelReportScreen> {
  ...
  postReport() async {
    String url = '$serverUrl/fashionReportReel/';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(children: [
          ...
          Text(
            "Why are you reporting this flick?",
            style: TextStyle(
                fontSize: 20,
