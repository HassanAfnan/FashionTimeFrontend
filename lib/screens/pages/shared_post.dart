                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            Text(posts[0].userName,style: const TextStyle(color: ascent,fontSize: 15,fontWeight: FontWeight.bold,fontFamily: 'Montserrat'),)
                          ],
                        ),
                      ],
                    ),
                          ...
                          children: [
                            Row(
                              children: [
                                posts[0].likeCount=="0"?
                                const SizedBox():
                                Text("${posts[0].likeCount}",style: TextStyle(fontFamily: 'Montserrat',color: primary),),
                              ],
                            ),
                            const SizedBox(width: 10,),
                            Row(
