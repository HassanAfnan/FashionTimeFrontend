...
import 'package:FashionTime/models/showcase_model.dart';
...
// Automatically close the dialog after 2 seconds
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   ),),
      body:
      loading == true ? SpinKitCircle(color: primary,size: 50,) : (posts.isEmpty ? const Center(child: Text("No Posts")) :
                            ...
                            children: [
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                const SizedBox(width: 10,),
                                                Flexible(child: Text(posts[index].userName,style: const TextStyle(fontFamily: 'Montserrat',color: ascent,fontWeight: FontWeight.bold),))
                                              ],
                                            ),
                                          ),
                                        ),
                                            ...
                                            PopupMenuItem(
                                              ...
                                              child: Row(
                                                children: const [
                                                  ...
                                                  SizedBox(width: 10,),
                                                  Text("View Profile",style: TextStyle(fontFamily: 'Montserrat'),),
                                                ],
                                              ),
                                            ),
                                            PopupMenuItem(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  //    child: Align(alignment: Alignment.topLeft,child: Text("About my style:", style: TextStyle(fontSize: 16.0,fontFamily: 'Montserrat',color: primary,fontWeight: FontWeight.bold))),
                                  //  ),
                                  ...
                                  //     style:  TextStyle(fontSize: 14.0,fontFamily: 'Montserrat',color: primary),
                                  //   ),
                                  // ),
                                  Row(
                                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                          ...
                                          child: SizedBox(
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                const SizedBox(width: 10,),
                                                Text(posts[index].userName,style: const TextStyle(fontFamily: 'Montserrat',color: ascent,fontWeight: FontWeight.bold),)
                                              ],
                                            ),
                                          ),
                                        ),
                                ...
                                child: SizedBox(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      AutoSizeText(
                                        posts[index].description,
                                        style: const TextStyle(fontSize: 20.0,fontFamily: 'Montserrat',color: dark1),
                                      ),
                                    ],
                                  ),
                                ),
