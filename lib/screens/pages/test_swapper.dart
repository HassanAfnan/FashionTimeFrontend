...
// Automatically close the dialog after 2 seconds
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //   ),),
      body: loading == true ? SpinKitCircle(color: primary,size: 50,) : (posts.length <= 0 ? const Center(child: Text("No Posts")) : CardSwiper(
                      ...
                      child: Container(
                        child: ConstrainedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              const Text("About my style:", style: TextStyle(fontSize: 16.0,fontFamily: 'Montserrat',color: dark1,fontWeight: FontWeight.bold)),
                              const SizedBox(height: 4,),
                              AutoSizeText(
                                  posts[index].description,
                                 style: const TextStyle(fontSize: 14.0,fontFamily: 'Montserrat',color: dark1),
                              ),
                            ],
                          ),
                        ),
                                    ...
                                    PopupMenuItem(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          const SizedBox(width: 10,),
                                          const Text("View Profile",style: TextStyle(fontFamily: 'Montserrat'),),
                                        ],
                                      ),
                                    ),
                                    PopupMenuItem(
